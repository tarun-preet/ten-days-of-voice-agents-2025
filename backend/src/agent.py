...
class Assistant(Agent):
    def __init__(self) -> None:
        ...
        super().__init__(
            instructions=f"""You are a helpful voice AI assistant. The user is interacting with you via voice, even if you perceive the conversation as text.
            ...
            - For questions about "today" or "now", use this information.""",
        )
